        ...
        private bool Validate(T entity)
        {
            ...
            foreach (var property in properties)
            {
                ...
                if (property.IsDefined(typeof(Required), false))
                {
                    ...
                    {
                        isValid = false;
                        messError.Add(string.Format(Properties.Resources.Msg_Required, displayName));
                ...
                if (property.IsDefined(typeof(CheckDuplicate), false))
                {
                    ...
                    {
                        isValid = false;
                        messError.Add(string.Format(Properties.Resources.Msg_Duplicate, displayName));
                        _serviceResult.MISACode = Enums.MISACode.NotValid;
                        _serviceResult.Messenger = Properties.Resources.Msg_IsNotValid;
                    }
                }
                ...
                if (property.IsDefined(typeof(CheckEmail), false))
                {
                    ...
                    //{
                    //    isValid = false;
                    //    messError.Add(Properties.Resources.Msg_Email);
                    //    _serviceResult.MISACode = Enums.MISACode.NotValid;
                    //    _serviceResult.Messenger = Properties.Resources.Msg_IsNotValid;
                    //}
                }
                ...
                if (property.IsDefined(typeof(MaxLength), false))
                {
                    ...
                    {
                        isValid = false;
                        messError.Add(msg??string.Format(Properties.Resources.Msg_MaxLength, length));
                        _serviceResult.MISACode = Enums.MISACode.NotValid;
                        _serviceResult.Messenger = Properties.Resources.Msg_IsNotValid;
                    }
                }
