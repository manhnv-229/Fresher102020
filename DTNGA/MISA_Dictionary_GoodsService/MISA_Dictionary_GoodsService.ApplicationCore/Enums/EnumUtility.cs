...
namespace MISA_Dictionary_GoodsService.ApplicationCore
{
    public class EnumUtility : IEnumUtility
    {
        ...
        public string GetResourceNameByValue(string value, string enumNameStringContains)
        {
            ...
            System.Resources.ResourceManager resourceManager = new System.Resources.ResourceManager("MISA_Dictionary_GoodsService.ApplicationCore.Properties.Resources", this.GetType().Assembly);
            var entry =
