    ...
    * */
    ...
    showConfirmForm() {
        $.ajax({
            ...
            this.formNoti = { 'state': 'WARN', 'message': `Bạn có chắc muốn xóa khách hàng <span style="font-weight:bold">${customerName}</span> có mã khách hàng <span style="font-weight:bold">${customerCode}</span> không` };
            this.showNoti();
        }.bind(this)).fail(function (res) {
